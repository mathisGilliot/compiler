...
public abstract class AbstractDeclClass extends Tree {
     ...
     * @param p
     */
    protected abstract void codeGenClassTable(DecacCompiler compiler, Pile p);
    
    
    /**
     * Génère le code de l'initialisation des champs
     * @param compiler
     * @param regs
     * @param p
     */
    protected abstract void codeGenInitField(DecacCompiler compiler, Registres regs, Pile p);
     ...
     * @param p
     */
    protected abstract void codeGenClassCodeMethod(DecacCompiler compiler, Registres regs, Pile p);
}
